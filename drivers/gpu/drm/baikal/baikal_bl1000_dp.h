...
#define BAIKAL_DP_HPD_INPUT_STATE			0x128
#define BAIKAL_DP_HPD_INPUT_STATE_HPD			BIT(0)
...
#define BAIKAL_DP_INTERRUPT_STATE_VS0_FIFO_OVERFLOW	BIT(7)
#define BAIKAL_DP_INTERRUPT_STATE_VS0_FIFO_ERROR	BIT(8)
#define BAIKAL_DP_INTERRUPT_STATE_VS1_FIFO_OVERFLOW	BIT(9)
#define BAIKAL_DP_INTERRUPT_STATE_VS1_FIFO_ERROR	BIT(10)
...
#define BAIKAL_DP_SRC0_USER_FIFO_STATUS			0x86c
#define BAIKAL_DP_SRC0_USER_FIFO_STATUS_ERROR		BIT(0)
#define BAIKAL_DP_SRC0_USER_FIFO_STATUS_OVERFLOW	BIT(1)
#define BAIKAL_DP_SRC0_USER_FRAMING_STATUS			0x870
